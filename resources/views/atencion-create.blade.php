    ...
    <div class="max-w-2xl p-6 mx-auto bg-white rounded-lg shadow-lg">
        <form wire:submit.prevent="store">
            ...
            <div class="relative mb-6">
                ...
                @if (strlen($search) > 2 && count($estudiantes) > 0 && !$idEstudiante)
                ...
                @elseif (strlen($search) > 2 && !$idEstudiante)
            ...
            <div class="mb-6">
                ...
                <input wire:model="motivo" type="text" id="motivo"
                    class="block w-full p-3 mt-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div class="mb-6">
                ...
                <input wire:model="resposable" type="text" id="resposable"
                    class="block w-full p-3 mt-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="Responsable de la atención">
                @error('resposable')
                    <span class="text-sm text-red-500">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea wire:model="descripcion_motivo" id="descripcion_motivo"
                    class="block w-full p-3 mt-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="Descripción detallada del motivo de atención"></textarea>
            ...
            <div class="mb-6">
                ...
                <textarea wire:model="otros_datos" id="otros_datos"
                    class="block w-full p-3 mt-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="Otros datos relevantes"></textarea>
                @error('otros_datos')
                    <span class="text-sm text-red-500">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mb-6 text-center">
                <button type="submit"
                    class="w-full p-3 text-white bg-blue-500 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    Guardar Atención
                </button>
            </div>
        </form>
