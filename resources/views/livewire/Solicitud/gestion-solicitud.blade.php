        ...
        <tbody class="text-gray-600 text-sm font-light">
            @foreach ($requisitos as $requisito)
                <tr class="border-b border-gray-200 hover:bg-gray-100 transition">
                    ...
                    <!-- Descripción -->
                    <td class="py-3 px-6">
                        <button class="bg-blue-800 text-red-700 px-3 py-1 rounded-lg hover:bg-blue-900 transition">
                            Ver
                        </button>
                    </td>
                    ...
                    <td class="py-3 px-6">
                        <div class="flex space-x-2">
                            <button wire:click="actualizarEstado({{ $requisito['id'] }}, 'Aprobado')"
                                class="bg-green-400 text-white px-3 py-1 rounded-lg hover:bg-green-500 transition">
                                ✔
                            </button>
                            <button wire:click="actualizarEstado({{ $requisito['id'] }}, 'Rechazado')"
                                class="bg-red-400 text-white px-3 py-1 rounded-lg hover:bg-red-500 transition">
                                ✖
                            </button>
                        </div>
                    </td>
