    ...
    <div class="max-w-2xl p-6 mx-auto bg-white rounded-lg shadow-lg">
        <form wire:submit.prevent="store">
            ...
            <div class="mb-6">
                ...
                <input wire:model="motivo" type="text" id="motivo" class="block w-full p-3 mt-2 border border-gray-300 rounded-md" placeholder="Motivo de atención" required>
            ...
            <div class="mb-6">
                ...
                <input wire:model="tipo" type="text" id="tipo" class="block w-full p-3 mt-2 border border-gray-300 rounded-md" placeholder="Tipo de atención" required>
            ...
            <div class="mb-6">
                ...
                <input wire:model="responsable" type="text" id="responsable" class="block w-full p-3 mt-2 border border-gray-300 rounded-md" placeholder="Responsable de la atención" required>
                @error('responsable') <span class="text-sm text-red-500">{{ $message }}</span> @enderror
            </div>
...
<div class="mb-6">
    ...
    <input wire:model="fecha_atencion" type="date" id="fecha_atencion" class="block w-full p-3 mt-2 border border-gray-300 rounded-md" required>
    @error('fecha_atencion') <span class="text-sm text-red-500">{{ $message }}</span> @enderror
            ...
            <div class="mb-6">
                ...
                <textarea wire:model="descripcion_motivo" id="descripcion_motivo" class="block w-full p-3 mt-2 border border-gray-300 rounded-md" placeholder="Descripción del motivo de la atención"></textarea>
            ...
            <div class="mb-6">
                ...
                <textarea wire:model="otros_datos" id="otros_datos" class="block w-full p-3 mt-2 border border-gray-300 rounded-md" placeholder="Otros datos relacionados con la atención"></textarea>
