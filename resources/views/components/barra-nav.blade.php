<div class="flex h-screen bg-gray-100">
    ...
    <!-- Barra lateral fija -->
    <div class="hidden md:flex flex-col w-64 bg-gray-800 sticky top-0">
        ...
        <div class="flex flex-col flex-1 overflow-y-auto">
            ...
            <nav class="flex-1 px-2 py-4 bg-gray-800">
                ...
                <a href="{{ route('citas') }}" class="flex items-center px-4 py-2 mt-2 text-gray-100 hover:bg-gray-700">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="size-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <a
                    href="{{ route('eventos-anuncios') }}"class="flex items-center px-4 py-2 mt-2 text-gray-100 hover:bg-gray-700">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="size-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M12 10.5v6m3-3H9m4.06-7.19-2.12-2.12a1.5 1.5 0 0 0-1.061-.44H4.5A2.25 2.25 0 0 0 2.25 6v12a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18V9a2.25 2.25 0 0 0-2.25-2.25h-5.379a1.5 1.5 0 0 1-1.06-.44Z" />
                    </svg>
                    eventos y anuncios-moises
                </a>
                ...
                @role('Coordinador')
                    <a href="{{ route('creacion-anuncio') }}"
                        ...
                        crear Anuncio-moises
                    </a>

                    <a href="{{ route('creacion-evento') }}"
                        class="flex items-center px-4 py-2 mt-2 text-gray-100 hover:bg-gray-700">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        crear eventos-moises

                    </a>
                @endrole

                @role('Trabajador Social')
                    <a href="{{ route('atencioness') }}"
                        class="flex items-center px-4 py-2 mt-2 text-gray-100 hover:bg-gray-700">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
