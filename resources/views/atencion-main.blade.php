                ...
                @foreach ($atenciones as $atencion)
                    <div class="relative w-full h-auto p-4 rounded-md shadow-lg bg-blue-50">
                        <div
                            ...
                            <i class="fa-solid fa-quote-left"></i> {{ $atencion->id }} <i
                        ...
                        @if ($expandedAtencionId == $atencion->id)
                            ...
                            <div class="grid grid-cols-2 gap-2 mt-4 text-sm">
                                ...
                                <div class="px-2 py-1"><strong>Fecha de Atención:</strong>
                                    {{ $atencion->fecha_atencion }}</div>
                                <div class="px-2 py-1"><strong>Estado:</strong> {{ $atencion->estado }}</div>
                                <div class="px-2 py-1"><strong>Observaciones:</strong> {{ $atencion->observaciones }}
                                </div>
                                <div class="px-2 py-1"><strong>Descripción del Motivo:</strong>
                                    {{ $atencion->descripcion_motivo }}</div>
                                <div class="px-2 py-1"><strong>Otros Datos:</strong> {{ $atencion->otros_datos }}</div>
                                <div class="px-2 py-1"><strong>Seguimiento de Caso:</strong>
                                    {{ $atencion->seguimiento_de_caso }}</div>
                                <div class="px-2 py-1">
