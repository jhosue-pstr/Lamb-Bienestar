            ...
            <form id="eventForm">
                <div class="mb-4">
                    <label for="eventName" class="block text-sm font-medium text-gray-700"
                        style="font-size: 1.25rem; margin-top: 50px;">Nombre del anuncio:</label>
                    <!-- Campo habilitado para seleccionar otros anuncios -->
                    <select id="eventName" name="eventName" class="block w-full mt-1 border-gray-300 rounded-md"
                        ...
                        @foreach ($anuncios as $otherAnuncio)
                            @if ($anuncio->id !== $otherAnuncio->id)
                                <option value="{{ $otherAnuncio->id }}">{{ $otherAnuncio->nombre }}</option>
                            @endif
                        @endforeach
                    </select>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="eventLocation" value="{{ $anuncio->ubicacion }}"
                        class="block w-full mt-1 border-gray-300 rounded-md" readonly>
                </div>

                <div class="mb-4">
                    <label for="eventDate" class="block text-sm font-medium text-gray-700"
                        style="font-size: 1.25rem;">Fecha:</label>
                    <input type="text" id="eventDate" value="{{ $anuncio->fecha }}"
                        class="block w-full mt-1 border-gray-300 rounded-md" readonly>
                </div>
                ...
                <div class="mb-2">
                    ...
                    <input type="text" id="eventTime" value="{{ $anuncio->hora }}"
                        class="block w-full mt-1 border-gray-300 rounded-md" readonly>
                </div>
                ...
                <div class="mb-2">
                    ...
                    <textarea id="eventDescription" class="block w-full mt-1 border-gray-300 rounded-md" rows="3" readonly>{{ $anuncio->descripcion }}</textarea>
                </div>
            </form>
        </div>
    </div>
